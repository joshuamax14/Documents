...
def neoReadHipsAngles():
    ...
    try:
        ...
        print(f"error occured while trying to read data: {hipsdecodedArrays}")
    return (counter,prox)
...
def readHipsAngles():
    ...
    try:
        ...
        #print("reading... state")
        ddaState = (decodedArrays["state"])
        ddaHipsFlex = np.asarray(decodedArrays["hipsFlex"])
        ddaAnkleFlex = np.asarray(decodedArrays["ankleFlex"])
        hipsdecodedArrays["state"]=ddaState
        hipsdecodedArrays["kneeFlex"]=ddaHipsFlex
...
def readDataHips():
    ...
    try:
        ...
        footdecodedArrays["distalR"]=ddaDistalR
        footdecodedArrays["proximalR"]=ddaProximalR
        print(f"error occured while trying to read foot data: {hipsdecodedArrays}")
    return (hipsdecodedArrays, footdecodedArrays)
